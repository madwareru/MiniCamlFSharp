module mini_caml_fsharp_core.InterpreterTestsKNorm
...
open mini_caml_fsharp_core.ClosureRepresentationInterpreter
open mini_caml_fsharp_core.CmmInterpreter
